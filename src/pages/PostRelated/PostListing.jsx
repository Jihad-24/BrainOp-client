...
const PostListing = () => {
  ...
  const displayedJobs = allPosts?.slice(0, displayCount);
  const svgs = [
    {
      svg: (
        <svg
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mx-3">
          {displayedJobs?.map((post) => (
            <div
              key={post._id}
              className="mx-auto my-10 flex max-w-[350px] flex-col items-center justify-center space-y-4 rounded-xl bg-[#3B3E47] text-white p-8 font-sans shadow-lg dark:bg-[#18181B]"
            >
              ...
              <div className="space-y-1 text-center">
                <h1 className="text-2xl  text-white/90">{post?.name}</h1>
                <p className="text-sm text-gray-400">{post?.occupation}</p>
              </div>
              <div className="flex w-full justify-between py-2">
                <div className="space-y-1 text-center">
                  <p className="text-white/70">Posts</p>
                  <p className="font-mono text-xltext-white/50">
                    {post?.posts}
                  </p>
                </div>
                <div className="space-y-1 text-center">
        ...
        <div className="text-center mx-auto md:w-[700px] lg:w-[1100px]">
          <h1 className="font-bold loading-10  text-3xl">
            ...
            <br />
            it seems like there are currently no <br /> posts has been added.
            Please <br /> add new post to see them.
          </h1>
        </div>
      )}
