    ...
    <footer className="">
      <div className="footer p-10 bg-[#252525] text-white">
        <aside>
          ...
          <p>
            BrainOp Ltd.
            <br />
            BrainOp is dedicated to constant Giving knowledge <br /> about Wide
            Range of Jobs.
          </p>
          <a
            href="#"
            className="flex gap-2 items-center py-1  hover:text-sky-500"
          >
          ...
          <a
            href="#"
            className="flex gap-2 items-center pt-1  hover:text-sky-500"
          >
        ...
        <nav>
          <header className="text-xl text-[#c8c7c7] font-bold py-1  hover:text-sky-500">
            Services
          </header>
          ...
          <a className="link link-hover hover:text-sky-500 py-1">
            Advertisement
          </a>
        </nav>
        <nav>
      ...
      <div className="footer items-center p-4 bg-neutral text-neutral-content">
        <aside className="items-center grid-flow-col">
          <img src={logo} alt="" />
          <p>
            Copyright © 2023 -Qode Interactive, All Rights Reserved By Code
            Corner.
          </p>
        </aside>
        <nav className="grid-flow-col gap-4 place-self-center md:place-self-center md:justify-self-end">
          <a href="#facebook" className="block text-xl">
            <FaFacebook></FaFacebook>
          </a>
          <a href="#twitter" className="block text-xl">
            <FaTwitter></FaTwitter>
          </a>
          <a href="#instagram" className="block text-xl">
